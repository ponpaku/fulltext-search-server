...
- 2026-01-16: 追加: `config.json` を読み込み、`.env` より低い優先度でアプリ設定を反映する仕組みを追加。
- 2026-01-16: 追加: `config.example.json` を用意し、`config.json` 不在時はコピーして設定を促すように変更。
- 2026-01-16: 更新: `.env` は運用依存の項目に寄せる方針を README と UI に反映。
